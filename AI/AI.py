...
def clasificar_texto(texto):
    respuesta = openai.ChatCompletion.create(
        ...
        messages=[
            {"role": "system", "content":
              "Eres un modelo que clasifica gastos en \
...
with open('AI/sets/gastos_clasificados.csv', mode='w',
...
# Función para limpiar y capitalizar la categoría
def limpiar_categoria(categoria):
    ...
    categorias_permitidas = ["Comida", "Transporte", "Vivienda", "Educación",
                             "Salud", "Entretenimiento", "Ahorro", "Inversión"]
...
gastos_clasificados = []
with open('AI/sets/gastos_clasificados.csv',
          mode='r', encoding='utf-8') as archivo:
    lector = csv.DictReader(archivo)
    for fila in lector:
...
print("Archivo gastos_clasificados_procesados.csv generado con éxito.")
